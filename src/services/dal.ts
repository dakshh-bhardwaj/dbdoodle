...
const STORAGE_KEY = 'dbdoodle:schemas'
const LAST_SCHEMA_KEY = 'dbdoodle:last-schema'
...
export function listSchemas(storage: DalStorage = localStorage): SchemaMeta[] {
...
export function nextUntitledName(storage: DalStorage = localStorage): string {
